...
_Система должна позволять отмечать отсутствие пледа в ячейке (в том случае, когда клиент не вернул плед), (нужно упомянуть, что это действие требует дополнительного подтверждения)_  
...
_Соответствие законодательству_
