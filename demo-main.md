...
Отобразить информацию о местоположения автоматов на карте.
...
Изъять грязные пледы из автомата: выбрать автомат, открыть ячейки, отметить наличие/отсутствие пледа в ячейке, забрать пледы, закрыть ячейки.
...
Отобразить статистику взятий в аренду из автоматов за определенный период 

Отобразить статистику возвратов пледов в автоматы за определенный период
...
Система должна отображать номер ячейки при взаимодействии клиента с ней 
...
Система должна отображать данные пользователя (номер телефона) на _странице с картой_ 
...
_Пользователь должен иметь возможность убедиться в том, что он выбрал правильный автомат посредством отображения системой фотографии автомата_
...
Система должна отображать номер ячейки при взаимодействии специалиста с ней 
...
_Возможность блокирования ячейки (ею нельзя пользоваться)_
